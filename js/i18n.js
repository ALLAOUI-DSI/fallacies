...
(function () {
  ...
  var FALLACY_DEFS_I18N = {
    ar: {
      ...
      "kafkatrap": "الادعاء بأن إنكار الاتهام يثبت صحته.",
      "sealioning": "طلب الأدلة والتفسيرات بشكل مستمر وغير صادق مع التظاهر بالأدب والموضوعية.",
      ...
      "whataboutism": "الرد على انتقاد بالإشارة إلى مشكلة مختلفة بدلاً من معالجة المسألة الأصلية.",
    ...
    fr: {
      ...
      "kafkatrap": "Affirmer que nier une accusation prouve sa véracité.",
      "sealioning": "Demander des preuves et des explications de manière persistante et malhonnête tout en paraissant poli et raisonnable.",
      ...
      "whataboutism": "Répondre à une critique en soulevant un problème différent au lieu de traiter la préoccupation initiale.",
